...
def cvglmnet(*, x,
    ...
    #   E       IndexError: boolean index did not match indexed array along dimension 0; dimension is 1 but corresponding boolean dimension is 56
    #
    #   It looks like the problem is shape.  Take the transpose and then flatten with ravel.

    #   ===================================================
    cvsd = cvsd.T.ravel()

    # the shapes should now be the same.  uncomment the print to check.
    # print(cvm.shape, cvsd.shape)
